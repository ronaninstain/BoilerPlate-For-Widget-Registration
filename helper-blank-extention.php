<?php
/*
Plugin Name: helper Blank Extension
Plugin URI:
...
final class Elementor_Blank_Extension {
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/Helper-blank-widget.php' );

		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Helper_Blank_Widget() );
